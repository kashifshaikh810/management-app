...
const CreateNewRewardModal = props => {
  return (
    <Modal
      visible={props.showCreateNewRewardModal}
      animationType="slide"
      transparent
      onRequestClose={() => props.setShowCreateNewRewardModal(false)}>
        ...
        <View style={styles.modalBody}>
          <View style={styles.cardHeadingContainer}>
            ...
            <View style={styles.closeIconContainer}>
              <Pressable
                onPress={() => props.setShowCreateNewRewardModal(false)}
                style={({pressed}) => [
          ...
          <ScrollView
            ...
            <Pressable
              ...
              onPress={() => props.uploadNewImage()}>
              {props?.newRewardImage ? (
                <Image
                  style={styles.newRewardImage}
                  source={{uri: props?.newRewardImage?.uri}}
                />
              ) : (
                <SvgUri
                  width="100"
