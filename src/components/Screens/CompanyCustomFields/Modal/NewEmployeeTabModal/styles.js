...
const styles = StyleSheet.create({
  ...
  cancelPressable: tw`w-3/12 h-12 rounded-xl justify-center items-center`,
  submitPressable: tw`w-3/12 h-12 ml-2 rounded-xl justify-center items-center`,
  ...
  permissionsText: tw`ml-3 mt-2 text-lg text-black capitalize`,
  viewText: tw`ml-3 mt-2 text-base text-black capitalize`,
  marginTopFour: tw`mt-4`,
  switch: tw`mt-1 ml-4`,
  marginTopOne: tw`mt-1`,
});
