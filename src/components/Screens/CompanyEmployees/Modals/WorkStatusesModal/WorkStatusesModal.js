...
const WorkStatusesModal = props => {
  return (
    <Modal
      visible={props.showWorkStatusesModal}
      animationType="slide"
      transparent
      onRequestClose={() => props.setShowWorkStatusesModal(false)}>
      <StatusBar barStyle="dark-content" backgroundColor="rgba(0,0,0,0.5)" />
      <View style={[styles.container, {backgroundColor: 'rgba(0,0,0,0.5)'}]}>
        <View style={styles.modalBody}>
          <View style={styles.cardHeadingContainer}>
            <Text style={styles.cardHeadingText}>new status</Text>
            <View style={styles.closeIconContainer}>
              <Pressable
                onPress={() => props.setShowWorkStatusesModal(false)}
                style={({pressed}) => [
          ...
          <ScrollView
            ...
            <View>
              <View style={styles.emailTextContainer}>
                <Text style={styles.email}>status name</Text>
              </View>
              <View>
                <TextInput
            ...
            <View>
              ...
              <View style={[styles.emailTextInput, styles.pickerContainer]}>
                <Picker
                  mode="dropdown"
                  selectedValue={props.workStatusesActiveOrNotAction}
                  onValueChange={(itemValue, itemIndex) =>
                    props.setWorkStatusesActiveOrNotAction(itemValue)
                  }>
...
export default WorkStatusesModal;
