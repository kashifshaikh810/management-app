...
const DepartmentModal = props => {
  return (
    <Modal
      visible={props.showDepartmentModal}
      animationType="slide"
      transparent
      onRequestClose={() => props.setShowDepartmentModal(false)}>
      <StatusBar barStyle="dark-content" backgroundColor="rgba(0,0,0,0.5)" />
      <View style={[styles.container, {backgroundColor: 'rgba(0,0,0,0.5)'}]}>
        <View style={styles.modalBody}>
          <View style={styles.cardHeadingContainer}>
            <Text style={styles.cardHeadingText}>new department</Text>
            <View style={styles.closeIconContainer}>
              <Pressable
                onPress={() => props.setShowDepartmentModal(false)}
                style={({pressed}) => [
          ...
          <ScrollView
            ...
            <View>
              <View style={styles.emailTextContainer}>
                <Text style={styles.email}>department name</Text>
              </View>
              <View>
                <TextInput
