...
const TerminationReasonModal = props => {
  return (
    <Modal
      visible={props.showTerminationReasonModal}
      animationType="slide"
      transparent
      onRequestClose={() => props.setShowTerminationReasonModal(false)}>
      <StatusBar barStyle="dark-content" backgroundColor="rgba(0,0,0,0.5)" />
      <View style={[styles.container, {backgroundColor: 'rgba(0,0,0,0.5)'}]}>
        <View style={styles.modalBody}>
          <View style={styles.cardHeadingContainer}>
            <Text style={styles.cardHeadingText}>new termination reason</Text>
            <View style={styles.closeIconContainer}>
              <Pressable
                onPress={() => props.setShowTerminationReasonModal(false)}
                style={({pressed}) => [
          ...
          <ScrollView
            ...
            <View>
              <View style={styles.emailTextContainer}>
                <Text style={styles.email}>termination reason name</Text>
              </View>
              <View>
                <TextInput
            ...
            <View>
              <View style={styles.emailTextContainer}>
                <Text style={styles.email}>termination</Text>
              </View>
