...
const JobPositionModal = props => {
  return (
    <Modal
      visible={props.showJobPositionModal}
      animationType="slide"
      transparent
      onRequestClose={() => props.setShowJobPositionModal(false)}>
      <StatusBar barStyle="dark-content" backgroundColor="rgba(0,0,0,0.5)" />
      <View style={[styles.container, {backgroundColor: 'rgba(0,0,0,0.5)'}]}>
        <View style={styles.modalBody}>
          <View style={styles.cardHeadingContainer}>
            <Text style={styles.cardHeadingText}>new employee position</Text>
            <View style={styles.closeIconContainer}>
              <Pressable
                onPress={() => props.setShowJobPositionModal(false)}
                style={({pressed}) => [
          ...
          <ScrollView
            ...
            <View>
              <View style={styles.emailTextContainer}>
                <Text style={styles.email}>position</Text>
              </View>
              <View>
                <TextInput
